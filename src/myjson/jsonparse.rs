...
/** # struct JSONUtils
 * JSON data, can be loaded from data file, string in memory
 * Full path list, generated by json_map_loop function
 * Full array path list for tables, generated by json_map_loop function
 * JSON map, created from full path list and full array path list
 * 
 */
#[derive(Debug, Clone)]
